...
export default function UploadCVForm({ className = "" }) {
    ...
    useEffect(() => {
        if (
            ...
            typeof data.curriculum_vitae === "string"
        ) {
    ...
    return (
        <section className={className}>
            <form onSubmit={submit}>
                <InputLabel
                    className="block font-extrabold text-lg text-gray-700 dark:text-gray-300"
                    htmlFor="curriculum_vitae"
                ...
                <InputError
                    message={errors.curriculum_vitae}
                    className="mt-2"
                />
