                                    ...
                                    <td className="align-top px-6 py-4 whitespace-no-wrap text-sm text-right text-gray-900 dark:text-slate-300">
                                        <div className="flex gap-2">
                                            <Link
                                                ...
                                                className="px-2 py-1 rounded-md bg-gray-800 text-white hover:text-slate-900 hover:bg-slate-200 hover:shadow-lg"
                                            >
                                                Edit
                                            </Link>
                                            <button
                                                onClick={() =>
                                                    confirmUserDeletion(job)
                                                }
                                                className=" disabled:bg-slate-400 disabled:shadow-none px-2 py-1 rounded-md bg-red-700 dark:bg-rose-700 hover:dark:bg-rose-500 text-white  hover:bg-red-500 hover:shadow-lg"
                                            >
                                                Delete
                                            </button>
                                        </div>
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-500">
                        Once this job is deleted, all of its resources and data
                        will be permanently deleted. Please ensure all data is
                        safely to be deleted.
                    </p>
